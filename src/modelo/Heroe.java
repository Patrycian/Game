 ...
 * Añade la habilidad especial (usable una vez por combate)
 * y el vínculo con el jugador propietario.
 */
public abstract class Heroe extends Personaje {
    ...
    /**
     * Intenta activar la habilidad especial del héroe.
     * Si ya fue usada en este combate, no tiene efecto y devuelve null.
     *
     * @param objetivo el personaje sobre el que se aplica (puede ser el enemigo o él mismo)
     * @return descripción de lo que ocurrió, o null si la habilidad ya estaba gastada
     */
    public final String usarHabilidad(Personaje objetivo) {
        if (habilidadUsada) return null;
        habilidadUsada = true;
        return aplicarHabilidad(objetivo);
    }

    /**
     * Implementación concreta de la habilidad especial.
     * Las subclases la definen y devuelven un texto descriptivo del efecto.
     */
    ...
    public boolean isHabilidadUsada()    { return habilidadUsada; }
    public String  getNombreHabilidad()  { return nombreHabilidad; }
    public String  getDescHabilidad()    { return descHabilidad; }
}
